...
int main() {
  ...
  CustomSoA d_soa(hf.x(), hf.y(), vf.v_y(), vf.v_r(), hf.description(), hf.r());
  ...
  std::cout << "Indirizzo della memoria di aggregated_soa: " << static_cast<void *>(aggregated_soa.metadata().data())
            << std::endl;
