...
from RecoHGCal.TICL.ticlDumper_cff import ticlDumper as _ticlDumper
...
def customiseForTICLBarrel(process, pfComparison=False):
    ...
    process.ticlBarrelTracksters = _trackstersProducer.clone(
        ...
        itername = "CLUE3D",
        layer_clusters_barrel_tiles = cms.InputTag("ticlLayerTileBarrelProducer", "ticlLayerTilesBarrel"),
    ...
    process.ticlSeedingGlobalBarrel = _ticlSeedingRegionProducer.clone()
    process.ticlLayerTileBarrelProducer = _ticlLayerTileProducer.clone(
    ...
    process.ticlBarrelTrackstersTask = cms.Task(process.ticlLayerTileBarrelProducer
                                                ,process.ticlSeedingGlobalBarrel
    ...
    process.ticlDumper_barrel = _ticlDumper.clone(
    ...
    process.ticl_barrel_consumer = cms.EDAnalyzer("GenericConsumer",
    ...
    process.FEVTDEBUGHLToutput_step_ticl_barrel = cms.EndPath(process.ticlDumper_barrel
                                                  +process.ticl_barrel_consumer)
