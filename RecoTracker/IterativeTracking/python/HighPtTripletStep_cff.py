...
# combination with gap removed as only source of fakes in current geometry (kept for doc) 
    layerList = ['BPix1+BPix2+BPix3', 'BPix2+BPix3+BPix4',
                 ...
                 'BPix2+BPix3+FPix2_pos', 'BPix2+BPix3+FPix1_neg',
                 'BPix1+BPix2+FPix2_pos', 'BPix1+BPix2+FPix1_neg',
                 'BPix2+FPix2_pos+FPix3_pos', 'BPix2+FPix1_neg+FPix2_neg',
                 'BPix1+FPix2_pos+FPix3_pos', 'BPix1+FPix1_neg+FPix2_neg',
#                 'BPix1+BPix2+FPix2_pos', 'BPix1+BPix2+FPix2_neg',
