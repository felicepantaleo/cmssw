...
def customiseForLowPtTripletsStepByCellularAutomaton(process, regionPtMin, thetacut, phicut, hardptcut, chi2lowpt, chi2highpt, lowpt, highpt):
    for module in [process.lowPtTripletStepSeeds]:
