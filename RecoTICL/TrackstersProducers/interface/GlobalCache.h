...
#ifndef RecoTICL_TrackstersProducers_GlobalCache_H__
#define RecoTICL_TrackstersProducers_GlobalCache_H__
...
#endif  // RecoTICL_TrackstersProducers_GlobalCache_H__
