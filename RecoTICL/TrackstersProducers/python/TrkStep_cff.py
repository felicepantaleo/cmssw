...
from RecoTICL.LayerClustersProducers.TICLSeedingRegions_cff import ticlSeedingTrk, ticlSeedingTrkHFNose
from RecoTICL.LayerClustersProducers.ticlLayerTileProducer_cfi import ticlLayerTileProducer as _ticlLayerTileProducer
