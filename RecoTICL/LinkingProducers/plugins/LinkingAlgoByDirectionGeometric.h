#ifndef RecoTICL_LinkingProducers_LinkingAlgoByDirectionGeometric_H__
#define RecoTICL_LinkingProducers_LinkingAlgoByDirectionGeometric_H__

#include <memory>
#include <array>
#include "RecoTICL/LinkingProducers/plugins/LinkingAlgoBase.h"
