...
// out of the same hits. Measured on ttbar, 24% of a pt-selected set has another selected
// particle as an ancestor, so an efficiency over such a set is meaningless.
//
