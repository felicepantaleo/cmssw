...
// and the selection configuration, never on a reco collection, so ONE producer per
// event replaces the identical computation every associator module used to repeat.
