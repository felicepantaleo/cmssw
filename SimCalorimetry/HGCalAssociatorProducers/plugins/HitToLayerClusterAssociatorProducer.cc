...
HitToLayerClusterAssociatorProducer<HIT>::HitToLayerClusterAssociatorProducer(const edm::ParameterSet &pset)
...
template <typename HIT>
HitToLayerClusterAssociatorProducer<HIT>::~HitToLayerClusterAssociatorProducer() {}

template <typename HIT>
void HitToLayerClusterAssociatorProducer<HIT>::produce(edm::StreamID,
                                                       edm::Event &iEvent,
...
template <typename HIT>
void HitToLayerClusterAssociatorProducer<HIT>::fillDescriptions(edm::ConfigurationDescriptions &descriptions) {
